...
window.playerGear = {
  ...
  bronzeStarAmulet: {
    mesh: function (box, cylinder, sphere, star) {
      star(
        window.amuletOffset[0],
        1.5 + window.amuletOffset[1],
        0,
        0.075,
        0.15,
        0.025,
  ...
  bronzeAntAmulet: {
    mesh: function (box, cylinder, sphere, star) {
      ...
      box(
        0.05 + window.amuletOffset[0],
        1.585 + window.amuletOffset[1],
        0.12,
        0.15,
        0.035,
        0.035,
  ...
  moonAmulet: {
    mesh: function (box, cylinder, sphere, star) {
      ...
      box(
        -0.06 + window.amuletOffset[0],
        1.6 + window.amuletOffset[1],
        0.075,
        0.09,
        0.16,
        0.07,
  ...
  kingBeetleAmulet: {
    mesh: function (box, cylinder, sphere, star) {
      ...
      box(
        window.amuletOffset[0] - 0.07,
        1.55 + window.amuletOffset[1],
        0.16,
        0.05,
        0.15,
        0.05,
  ...
  mask: {
    ...
    helmet: {
      mesh: function (box, cylinder, sphere, a, b, putFace = true) {
        ...
        box(
          0,
          0.4 - Math.cos(-30 * 0.01745329251) * 0.2,
          0.2 - Math.sin(-30 * 0.01745329251) * 0.2,
          0.28 * 2 + 0.05,
          0.05,
          0.05,
          [-30, 0, 0],
    ...
    fireMask: {
      ...
      applyStats: function (stats, player) {
        stats.capacityMultiplier *= 1.75;
        stats.redPollen *= 1.6;
        stats.instantRedConversion = window.applyPercentage(
          stats.instantRedConversion,
          0.2
        );
        stats.instantFlameConversion = window.applyPercentage(
          stats.instantFlameConversion,
          0.5
        );
        stats.defense += 0.35;
        stats.redBeeAbilityRate *= 1.15;
    ...
    bubbleMask: {
      mesh: function (box, cylinder, sphere) {
        ...
        box(-0.1, 0.4, 0.32, 0.05, 0.1, 0.1, false, [
          0.4 * 0.7,
          1 * 0.7,
          1.3 * 0.7,
        ]);
        ...
        box(0, 0.25, 0.32, 0.2, 0.05, 0.1, false, [
          0.4 * 0.7,
          1 * 0.7,
          1.3 * 0.7,
        ]);
      ...
      applyStats: function (stats, player) {
        ...
        stats.instantBlueConversion = window.applyPercentage(
          stats.instantBlueConversion,
          0.2
        );
    ...
    gummyMask: {
      ...
      applyStats: function (stats, player) {
        ...
        stats.goo *= 1.75;
        stats.instantWhiteConversion = window.applyPercentage(
          stats.instantWhiteConversion,
          0.25
        );
  ...
  belt: {
    ...
    beltPocket: {
      mesh: function (box, cylinder, sphere) {
        box(0, -0.2, 0.25, 0.3, 0.2, 0.3, false, [
          0.7 * 1.2,
          0.5 * 1.2,
          0.2 * 1.2,
        ]);
  ...
  boots: {
    ...
    gummyBoots: {
      mesh: function (box, cylinder, sphere) {
        box(-0.2, -0.5, 0.04, 0.36, 0.15, 0.73, false, [
          0.1 * 1.75,
          1 * 1.75,
          0.5 * 1.75,
        ]);
        ...
        box(-0.2, -0.35, 0, 0.325, 0.2, 0.6, false, [
          1 * 1.75,
          0.2 * 1.75,
          1 * 1.75,
        ]);
        ...
        box(-0.2, -0.35, 0.2, 0.15, 0.05, 0.25, false, [
          0.1 * 1.75,
          1 * 1.75,
          0.5 * 1.75,
        ]);
    ...
    coconutClogs: {
      mesh: function (box, cylinder, sphere) {
        ...
        box(0.2, -0.4, 0.04, 0.36, 0.15, 0.73, false, [1.35, 1.35, 1.35]);
        box(-0.2, -0.25, 0, 0.325, 0.2, 0.6, false, [
          0.4 * 1.3,
          0.3 * 1.3,
          0.2 * 1.3,
        ]);
    ...
    hikingBoots: {
      mesh: function (box, cylinder, sphere) {
        box(-0.2, -0.5, 0.065, 0.325, 0.15, 0.73, false, [
          0.7 * 0.5,
          0.4 * 0.5,
          0.3 * 0.5,
        ]);
